    ...
    <Box marginLeft="15px">
      <Slider {...settings} className="leadership-carousel">
        <div style={slideStyle}>
          <Image
            src="/images/frontend-pages/homepage/user1.jpeg"
            alt="user-img"
            width={270}
            height={290}
        ...
        <div style={slideStyle}>
          <Image
            src="/images/frontend-pages/homepage/user2.jpeg"
            alt="user-img"
            width={270}
            height={290}
            objectFit="cover"
        ...
        <div style={slideStyle}>
          <Image
            src="/images/frontend-pages/homepage/user3.jpeg"
            alt="user-img"
            width={270}
            height={290}
            objectFit="cover"
        ...
        <div style={slideStyle}>
          <Image
            src="/images/frontend-pages/homepage/user4.jpeg"
            alt="user-img"
            width={270}
            height={290}
            objectFit="cover"
        ...
        <div style={slideStyle}>
          <Image
            src="/images/frontend-pages/homepage/user5.jpeg"
            alt="user-img"
            width={270}
            height={290}
            objectFit="cover"
        ...
        <div style={slideStyle}>
          <Image
            src="/images/frontend-pages/homepage/user6.jpeg"
            alt="user-img"
            width={270}
            height={290}
            objectFit="cover"
